...
- there are 471 participants appear in both datasets. the combined data
  set has 471 rows and 11 cols. the names of variables are id, baseline,
  time_2, time_4, time_6, time_8, current_age, sex, education, apoe4,
  age_at_onset.
...
- there are 1884 participants appear in both datasets. the combined data
  set has 1884 rows and 9 cols. the names of variables are id, baseline,
